...
def get_rooms_for_user(username):
    """
    gets the rooms in which a specified user is in the room
    :param username:
...
def is_room_admin(room_id, username):
    """
    checks the database if the specified user in and admin for a specified room
    :param room_id:
    :param username:
...
def save_message(room_id, text, sender):
    """
    saves the messages send in a room to the database
    :param room_id:
    :param text:
    :param sender:
    :return: None
