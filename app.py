...
from DB import get_user, save_user, get_rooms_for_user, get_room, is_room_member, get_room_members, add_room_members, \
    remove_room_members, update_room, is_room_admin, save_room, save_message, get_messages, delete_room
...
def home():
    ...
    """
    return render_template('index_dhruv.html')
...
def signup():
    ...
    if request.method == 'POST':
        ...
        if username == '' or email == '' or password == '':
            ...
            return render_template('signup_try.html', message=message)
        else:
            try:
...
def create_room():
    ...
    return render_template('create_room_try.html',
                           message=message)
...
def edit_room(room_id):
    ...
    if room and is_room_admin(room_id, current_user.username):
        ...
        return render_template('edit_room_try.html',
                               room=room,
...
def view_room(room_id):
    ...
    if room and is_room_member(room_id, current_user.username):
        ...
        return render_template('view_room_try.html',
...
def remove_room(room_id):
    if current_user.is_authenticated and is_room_admin(room_id, current_user.username):
        delete_room(room_id)
        return redirect(url_for('home'))
    else:
